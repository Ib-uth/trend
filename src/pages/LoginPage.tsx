...
import { Mail, Lock, Loader2, ArrowRight, TrendingUp, Github, Chrome } from 'lucide-react';

export default function LoginPage() {
  const [email, setEmail] = useState('analyst@trendpulse.ai');
    ...
    <div className="min-h-screen bg-[#050505] flex flex-col items-center justify-center p-4 relative overflow-hidden">
      ...
      >
            ...
            <div className="space-y-2">
              ...
              <div className="relative group">
                ...
                <input 
                  ...
                  placeholder="analyst@trendpulse.ai"
                />
              </div>
            </div>
        ...
        <p className="mt-8 text-center text-[10px] font-bold uppercase tracking-widest text-gray-600">
          Don't have an account? <a href="#" className="text-emerald-500 hover:text-emerald-400 transition-colors">Create one</a>
        </p>
      </motion.div>
    </div>
  );
